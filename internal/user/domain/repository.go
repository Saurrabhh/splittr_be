...
type Repository interface {
	...
	CreateFriendship(ctx context.Context, userID, friendID, status, actionUserID string) error
	UpdateFriendshipStatus(ctx context.Context, userID, friendID, status, actionUserID string) error
	...
	ListFriendsByStatus(ctx context.Context, userID string, status string) ([]FriendWithStatus, error)
